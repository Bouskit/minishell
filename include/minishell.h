...
bool					handle_operator(const char *line, int *i,
							t_token **tokens);
...
int						add_cmd_args(t_command **cmds, t_token **token,
							int *ac);
int						add_cmd_outfile(t_command **cmd, t_token **token,
							int *out_i);
int						add_cmd_infile(t_command **cmd, t_token **token,
							int *in_i);
t_token					*init_parsing(char *cmd_line, t_env *env, int exit_code,
							t_index *num);
bool					handle_pipe(t_command **cmd, t_command **first_cmd,
							t_index *num);
bool					handle_non_pipe(t_command **cmd, t_token **tokens,
							t_index *num);
t_command				*parse_tokens(char *cmd_line, t_env *env,
							int exit_code);
...
int						execute_one_builtin(t_command *cmd, t_env *env,
							int exit_code);
