...
/*   Updated: 2025/04/15 01:19:13 by bboukach         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (!ft_strcmp("echo", name) || !ft_strcmp("cd", name) || !ft_strcmp("pwd",
			name) || !ft_strcmp("export", name) || !ft_strcmp("unset", name)
		|| !ft_strcmp("env", name) || !ft_strcmp("exit", name))
		return (1);
	else
		return (0);
}
